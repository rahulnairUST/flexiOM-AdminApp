		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Product Allocation - Admin",
									"targetURL": "#comprdallocadminmngprdallocadmin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comprdallocadminmngprdallocadmin-display": {
								"semanticObject": "comprdallocadminmngprdallocadmin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.prd.alloc.admin.mngprdallocadmin",
									"url": sap.ui.require.toUrl("com/prd/alloc/admin/mngprdallocadmin")
								}
							}
						}
					}
